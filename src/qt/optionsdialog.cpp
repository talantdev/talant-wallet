    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new TalantUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->talantAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Talant."), QMessageBox::Ok);
