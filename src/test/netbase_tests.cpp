...
{
    BOOST_CHECK(TestSplitHost("www.talant.org", "www.talant.org", -1));
    BOOST_CHECK(TestSplitHost("[www.talant.org]", "www.talant.org", -1));
    BOOST_CHECK(TestSplitHost("www.talant.org:80", "www.talant.org", 80));
    BOOST_CHECK(TestSplitHost("[www.talant.org]:80", "www.talant.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:7449", "127.0.0.1", 7449));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:7449", "127.0.0.1", 7449));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:7449", "::ffff:127.0.0.1", 7449));
    BOOST_CHECK(TestSplitHost("[::]:7449", "::", 7449));
    BOOST_CHECK(TestSplitHost("::7449", "::7449", -1));
    BOOST_CHECK(TestSplitHost(":7449", "", 7449));
    BOOST_CHECK(TestSplitHost("[]:7449", "", 7449));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:7449", "127.0.0.1:7449"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:7449", "[::]:7449"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
