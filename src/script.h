...
#ifndef H_TALANT_SCRIPT
#define H_TALANT_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CTalantAddress
 */
...
public:
    ...
    // Pre-version-0.6, Talant always counted CHECKMULTISIGs
