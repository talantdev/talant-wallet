...
uint256 hashGenesisBlock("0x00000000106d410f06c3dd5de4c11a5104183ca423b2bf26abcf01c3d1c2a11a");
...
const string strMessageMagic = "Talant Signed Message:\n";
...
bool CTxOut::IsDust() const
{
    ...
    // so dust is a txout less than 54 uTLT
...
static const int64 nTargetTimespan = 20 * 60; // 20min
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000000106d410f06c3dd5de4c11a5104183ca423b2bf26abcf01c3d1c2a11a");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Japan News 10 Jun 2017 Abe Moon to hold talks in Germany in July";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("03668afdb0fe5548271967f1a6713017105cd6a828e03909a67962e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c384df7ba0b8d578a4c702b6bf11d5a") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1497123763;
        block.nBits    = 0x1d00ffff;
        block.nNonce   = 272976421;
        ...
        assert(block.hashMerkleRoot == uint256("0x4567f3b40fb6bf52929c98d64b64bdb3d35edf471cc70491acd34d0f286d7a29"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xdc, 0x37, 0x4b, 0x51 };
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("TalantMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("TalantMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static TalantMiner(CWallet *pwallet)
{
    printf("TalantMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("talant-miner");
    ...
    try { loop {
        ...
        printf("Running TalantMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("TalantMiner terminated\n");
        throw;
    }
}

void GenerateTalants(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&TalantMiner, pwallet));
}
