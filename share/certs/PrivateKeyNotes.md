...
unlocked to sign the Talant-Qt.app bundle.
...
allowing somebody to distribute a Talant-Qt.app or talant-qt-setup.exe with a valid
...
that the talant-qt.exe file inside the installer had not been tampered with.
